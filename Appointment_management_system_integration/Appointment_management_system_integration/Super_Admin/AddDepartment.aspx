<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddDepartment.aspx.cs" Inherits="Appointment_management_system_integration.Super_Admin.AddDepartment" %>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-12 mb-5">
                    ...
                    <input type="button" id="btnCreateDepartment" value="Create Department" class="btn btn-success float-right">
                </div>
            </div>
        </section>
        <%--Add Department--%>
        ...
        $('#btnCreateDepartment').click(function (e) {
            ...
            if (DepartmentName == "") {
                ...
                Employees.forEach(function (index) {
                    EmpID = EmpID + "," + index.EmpID;
                });
                $.ajax({
                    type: "POST",
                    url: "AddDepartment.aspx/CreateDepartment",
