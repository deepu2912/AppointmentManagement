                            ...
                            <div id="appointment_popup_data" class="col-lg-12 col-12">
                                <div class="book-appointment-container" style="">
                                    ...
                                    <div class="appointment-day-slots" id="appointment-day-slots">
                                        <%--    <label class="set">
                                            <input type="radio" name="select-slot" />
                                            <div class="date-no"><span>10:30 Am - 11:00 Am</span>  </div>
                                            <span style="font-size: 12px;">20 seats</span>
                                        </label>

                                        <label class="set">
                                            <input type="radio" name="select-slot" class="Booked" />
                                            <div class="date-no Booked"><span>10:30 Am - 11:00 Am</span>  </div>
                                            <span style="font-size: 12px;">Booked</span>
                                        </label>
                                        <label class="set">
                                            <input type="radio" name="select-slot" />
                                            <div class="date-no"><span>10:30 Am - 11:00 Am</span>  </div>
                                            <span style="font-size: 12px;">15 seats</span>
                                        </label>
                                        <label class="set break">
                                            <input type="radio" name="select-slot" class="Break" />
                                            <div class="date-no Break"><span>10:30 Am - 11:00 Am</span>  </div>
